...
$ret=mysqli_query($conn,"select productImage1 from products where id='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($conn,"update  products set productImage1='$productimage1' where id='$pid' ");
...
$query=mysqli_query($conn,"select productName,productImage1 from products where id='$pid'");
$cnt=1;
